	...
	<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
						节点名称：<input type="text" name="name" /><br/>
						URL地址：<input type="text" name="url" /><br/>
				...
				<div class="modal-footer">
					<button id="menuEditResetBtn" type="reset" class="btn btn-default" data-dismiss="modal">重置</button>
					<button id="menuEditBtn" type="button" class="btn btn-success"><i class="glyphicon glyphicon-plus"></i> 保存</button>
				</div>
			</form>
			</div>
	</div>
